...
cardPopup.addEventListener("submit", handleFormSubmit);
...
function createCard({ name, link }) {
  ...
  const imageFormOpenButtons = cardElement.querySelectorAll(".card__image");
  imageFormOpenButtons.forEach(function (image) {
